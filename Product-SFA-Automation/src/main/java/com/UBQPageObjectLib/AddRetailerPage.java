...
public class AddRetailerPage extends WebDriverCommonLib {
	...
	// ----EnterLandMark----//
		public void EnterLandMark(String LandMark) {
			entervalue(LandMark, driver.findElementById("ubq.mobi.and.product:id/landmark_txt"));
		}
	...
	// ----select channel----//
	public void selectchannel1() {
		buttonClick(driver.findElementByAndroidUIAutomator(
				"new UiScrollable(new UiSelector()).scrollIntoView(text(\"Open Market\"));"));
	}
	// ----select channel----//
		public void selectchannel(String visibletext ) {
			buttonClick(driver.findElementByAndroidUIAutomator(
